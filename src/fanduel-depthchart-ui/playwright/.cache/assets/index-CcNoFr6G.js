const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/AddPlayerForm-7Av05PIz.js","assets/jsx-runtime-Oi8CS8Fg.js","assets/depthChart-DP6Jzb32.js","assets/BackupsLookup-WiMKz9Dz.js","assets/DepthChartTable-DNH1pgNu.js","assets/Header-CnvwuW4d.js"])))=>i.map(i=>d[i]);
...
const C__Workspace_VinhNgo_FanDuel_Coding_Challenge_src_fanduel_depthchart_ui_src_components_AddPlayerForm_AddPlayerForm = () => __vitePreload(() => import('./AddPlayerForm-7Av05PIz.js'),true              ?__vite__mapDeps([0,1,2]):void 0).then((mod) => mod.AddPlayerForm);
const C__Workspace_VinhNgo_FanDuel_Coding_Challenge_src_fanduel_depthchart_ui_src_components_BackupsLookup_BackupsLookup = () => __vitePreload(() => import('./BackupsLookup-WiMKz9Dz.js'),true              ?__vite__mapDeps([3,1,2]):void 0).then((mod) => mod.BackupsLookup);
const C__Workspace_VinhNgo_FanDuel_Coding_Challenge_src_fanduel_depthchart_ui_src_components_DepthChartTable_DepthChartTable = () => __vitePreload(() => import('./DepthChartTable-DNH1pgNu.js'),true              ?__vite__mapDeps([4,1,2]):void 0).then((mod) => mod.DepthChartTable);
const C__Workspace_VinhNgo_FanDuel_Coding_Challenge_src_fanduel_depthchart_ui_src_components_Header_Header = () => __vitePreload(() => import('./Header-CnvwuW4d.js'),true              ?__vite__mapDeps([5,1]):void 0).then((mod) => mod.Header);
__pwRegistry.initialize({ C__Workspace_VinhNgo_FanDuel_Coding_Challenge_src_fanduel_depthchart_ui_src_components_AddPlayerForm_AddPlayerForm,
  C__Workspace_VinhNgo_FanDuel_Coding_Challenge_src_fanduel_depthchart_ui_src_components_BackupsLookup_BackupsLookup,
  C__Workspace_VinhNgo_FanDuel_Coding_Challenge_src_fanduel_depthchart_ui_src_components_DepthChartTable_DepthChartTable,
  C__Workspace_VinhNgo_FanDuel_Coding_Challenge_src_fanduel_depthchart_ui_src_components_Header_Header });

export { getDefaultExportFromCjs as g, reactExports as r };
//# sourceMappingURL=index-CcNoFr6G.js.map
